...
typedef struct
{
	CLK_Prescaler_TypeDef HSIDIV_Prescaler;
	CLK_Prescaler_TypeDef CPUDIV_Prescaler;

	CLK_SwitchMode_TypeDef SwitchMode;
	CLK_Source_TypeDef  NewClock;
	FunctionalState ITState;
	CLK_CurrentClockState_TypeDef CurrentClockState;
