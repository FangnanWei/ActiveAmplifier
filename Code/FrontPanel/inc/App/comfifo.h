...
/**********************************************
            function
***********************************************/
int ReadComFifo(ComFifo_t *pComFifo, char *buf, int len);	 //读走
int CopyReadComFifo(ComFifo_t *pComFifo, char *buf, int len);//拷贝读取
int WriteComFifo(ComFifo_t *pComFifo, char *buf, int len);   //写入
