...
struct I2c{
	...
	int (*Read)(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len);
	int (*Write)(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len);
	int (*Read_16)(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len);
	int (*Write_16)(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len);
