...
static int I2c_Read(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len)
{
	int timeout = 0;
    if(len==0)
		return 1;
...
static int I2c_Write(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len)
{
    int timeout = 0;
    int i = 0;
...
static int I2c_Read_16(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len)
{
	int timeout = 0;
    if(0 == len)
		return 1;
...
static int I2c_Write_16(const struct I2c *self, uint8_t slaveAddr, uint8_t addr, uint8_t *buf, uint16_t len)
{
    int timeout = 0;
    int i = 0;
